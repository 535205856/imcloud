 ...
 * class desc：TODO
 * createTime：2019/11/13 4:49 PM
 * creator：awesome
 */
public class CodeGenerator {
    private static String AUTHOR = "awesome.li";
    private static String DATABASE = "im-cloud";
    private static String DATABASE_USERNAME = "root";
    private static String DATABASE_PASSWORD = "awesome";
    private static String PROJECT = "com.awesome.im.chat";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath+"/im-business/im-simple-chat/" + "/src/main/java");
        gc.setAuthor(AUTHOR);
        gc.setOpen(false);
...
//        strategy.setInclude(scanner(""));
        strategy.setInclude("push_message");
